...
class Lead(models.Model):
    ...
    headline = models.CharField(max_length=500, null=True, blank=True, default="")
    industry = models.CharField(max_length=200, null=True, blank=True, default="")
    current_company = models.CharField(max_length=200, null=True, blank=True, default="")
    current_title = models.CharField(max_length=200, null=True, blank=True, default="")
    ...
    languages = models.JSONField(null=True, default=list, blank=True)
