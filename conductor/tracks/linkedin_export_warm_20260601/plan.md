...
- [ ] Task 1.2: Create and run Django migration for `CampaignLead`
...
- [ ] Task 2.1: Create `linkedin/importers/linkedin_export.py` with CSV helpers for ZIP reads and LinkedIn note/header handling
...
- [ ] Task 3.1: Add `oo linkedin import-export <zip-path> --campaign "<campaign>"` command
